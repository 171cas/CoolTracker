...
const HomePage = () => {
    const resumeLink = async (e) => {
        e.preventDefault();
        window.location.replace('https://www.linkedin.com/in/cesar-solano-320211230/');
    };
    const gitLink = async (e) => {
        e.preventDefault();
        window.location.replace('http://www.https://github.com/171cas/');
    };
    ...
    return (
        <div className='containerHome'>
            ...
            <div>
                <FontAwesomeIcon icon={faGithub} className='linkClass' onClick={gitLink} />
